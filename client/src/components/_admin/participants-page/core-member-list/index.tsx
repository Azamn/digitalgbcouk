...
export default function CoreMemberList() {
  const { data, isLoading, isError, refetch } = useGetallCoreMembersQuery();
      ...
      {filteredMembers.length === 0 ? (
        <div className="flex h-64 flex-col items-center justify-center rounded-lg border border-dashed bg-gray-50">
          <p className="text-gray-500">
            {search ? "No members match your search" : "No core members found"}
          </p>
          {search && (
            <Button
              variant="ghost"
                ...
                <CardHeader className="flex flex-row items-start justify-between pb-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="overflow-hidden">
                      ...
                      <Badge
                        variant="default"
                        className="mt-1 gap-1 bg-yellow-100 text-yellow-800 hover:bg-yellow-100"
                      >
