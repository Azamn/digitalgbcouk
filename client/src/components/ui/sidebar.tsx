  ...
  (
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="bg-sidebar text-sidebar-foreground w-[--sidebar-width] bg-red-500 p-0 [&>button]:hidden"
            style={
              {
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "fixed inset-y-0 z-10 hidden h-svh w-[--sidebar-width] bg-white text-dark transition-[left,right,width] duration-200 ease-linear md:flex",
            side === "left"
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      {...props}
    >
      <MenuIcon className="h-6 w-6" /> {/* Larger icon */}
